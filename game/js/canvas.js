...
function buildGameCanvas() {
  ...
  resultTitleTxt.y = (canvasH / 100) * 45 - 50;
  ...
  resultShareTxt.y = (canvasH / 100) * 52 - 50;

  resultShareTxt1 = new createjs.Text();
  //set font weight 700
  resultShareTxt1.fontWeight = "800";
  resultShareTxt1.font = " 150px roboto bold";
  resultShareTxt1.color = "red";
  resultShareTxt1.textAlign = "center";
  resultShareTxt1.textBaseline = "alphabetic";
  resultShareTxt1.text = "300";
  resultShareTxt1.x = canvasW / 2;
  resultShareTxt1.y = (canvasH / 100) * 52 + 90;
  ...
  buttonCancelResult.scaleX = buttonCancelResult.scaleY = 0.5;
  buttonContinue.scaleX = buttonContinue.scaleY = 0.5;
  resultContainer.scaleX = resultContainer.scaleY = 1.5;
  resultContainer.x = -300;
  resultContainer.y = -200;
